                            ...
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-4 pe-md-0">
                                        <img src="{{ asset('upload/login.png') }}" src="width:100%" alt="gambarlogin">
                                    </div>
                                        ...
                                        <div class="auth-form-wrapper px-4 py-5">
                                            ...
                                            <form class="forms-sample" method="post" action="{{ route('login') }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="login" class="form-control" id="login" placeholder="Email/Name/Phone" value="{{ old('login') }}" required/>
